...
import { LIST_STATUSES, STATUS_LABELS, STATUS_COLORS } from "../../types";
...
function ListGroup({ status, tasks, onCardClick }: { status: TaskStatus; tasks: Task[]; onCardClick?: (task: Task) => void }) {
  ...
  return (
    <div
      ...
      className={ cx(
        css.group,
        { [css.groupOver]: isOver, [css.groupEmpty]: tasks.length === 0 })
      }
